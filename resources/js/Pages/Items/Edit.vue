                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" id="active" name="status" class="ml-3" v-model="form.is_selling" value="1">
                                                <label for="active" class="ml-2 mr-4">販売中</label>
                                                <input type="radio" id="disactive" name="status" class="ml-3" v-model="form.is_selling" value="0">
                                                <label for="disactive" class="ml-2 mr-4">停止中</label>
