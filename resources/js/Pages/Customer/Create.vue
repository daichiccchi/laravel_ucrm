                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" id="man" name="gender" class="ml-3"
                                                    v-model="form.gender" value="0">
                                                <label for="man" class="ml-2 mr-4">男性</label>
                                                <input type="radio" id="woman" name="gender" class="ml-3"
                                                    v-model="form.gender" value="1">
                                                <label for="woman" class="ml-2 mr-4">女性</label>
                                                <input type="radio" id="other" name="gender" class="ml-3"
                                        ...
                                        <div class="p-2 w-full">
                                            <button
                                                class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">登録完了</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
